...
// Import unified color system from neural-visuals
const { COLORS: colors, NeuralFormatter, THEMES } = require('../hooks/neural-visuals.cjs');

// Icons for visual feedback (CLI-specific, not duplicated elsewhere)
const icons = {
  check: '\u2714',
  cross: '\u2718',
  warning: '\u26A0',
