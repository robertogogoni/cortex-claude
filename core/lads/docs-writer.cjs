/**
 * Claude Memory Orchestrator - Docs Writer
 *
...
class DocsWriter {
  ...
  _getChangelogContent() {
    ...
    if (!content) {
      content = `# Claude Memory Orchestrator - Changelog

This file is auto-generated by CMO's DocsWriter.
...
- Tags: ${memory.tags?.join(', ') || 'none'}`,
  ...
  logEvent(event, details = {}) {
    this.addChangelogEntry({
      type: 'system_event',
      component: details.component || 'CMO',
      description: event,
  ...
  _getDecisionsContent() {
    ...
    if (!content) {
      content = `# Claude Memory Orchestrator - Decision Log

This file tracks configuration decisions and their outcomes.
Auto-generated by CMO's DocsWriter.
